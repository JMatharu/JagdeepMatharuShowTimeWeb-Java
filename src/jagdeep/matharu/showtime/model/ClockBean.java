package jagdeep.matharu.showtime.model;
...
public class ClockBean {
	...
	private DateFormat getDateFormat(String format, Locale locale)
		...
		if (fmt.equals("FULL")) {
			...
			throw new DateTimeFormatException(format
					+ " is not a recognized date-time format");
		}
		return df;
	}

	private String formatTime(Date time, String format, Locale locale)
			throws DateTimeFormatException {
		DateFormat df = getDateFormat(format, locale);
		return df.format(time);
	}

	public String getCurrentTimeFormatted(String timeFormat, Locale locale)
			throws DateTimeFormatException {
		return formatTime(getCurrentTime(), timeFormat, locale);
	}

	public String getCurrentTimeFormatted(String timeFormat)
			throws DateTimeFormatException {
